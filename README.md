...
The total possible range is from 0 to 1; higher GGGI scores indicate that a country is closer to gender equality. The lowest score is .599 in Saudi Arabia, and the highest is .877 in Iceland. Spearman's correlation coefficient will be used here because non-parametric statistics are most suitable.
