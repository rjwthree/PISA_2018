...
The correlation with mean and median scores in both math and reading are about 0.4, whether it be the total, female, or male scores. This is consistent with an association between greater gender equality and human development in general. The correlation with sex differences at the center - U3 and probability of superiority - is .25-.28 in math and about .21 in reading. That is, there is a mild tendency for males to perform better relative to females in more gender-equal countries.
