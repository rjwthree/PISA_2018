...
The total possible range is from 0 to 1; 1 would indicate equality (or female advantage) on all four subindices. The lowest score is .599 in Saudi Arabia, and the highest is .877 in Iceland. Spearman's correlation coefficient will be used here because non-parametric statistics are most suitable.
